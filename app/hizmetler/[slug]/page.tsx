                    ...
                    <div className="container-main">
                        ...
                        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                            {service.internalLinks.relatedServices.map((relatedSlug, index) => {
                                ...
                                // Determine the path for the related service
                                const isNeighborhood = neighborhoodSlugs.includes(relatedSlug);
                                const path = isNeighborhood ? `/${relatedSlug}` : `/hizmetler/${relatedSlug}`;
